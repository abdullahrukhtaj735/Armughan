...
class Page_Settings
{
	...
	{
		Controls_Manager::add_tab(self::PANEL_TAB, __('New Tab', 'cf-core'));
	}
	...
	public function register_document_controls($document)
	{
		...
		$document->add_control(
			'text',
			[
				'label' => __('Title', 'cf-core'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Title', 'cf-core'),
			]
		);
